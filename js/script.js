$(function(){
    ...
    var form = $('#contact-form').find('form'),
        ...
        errorMessages = {
            ...
            email: 'Nu ati introdus o adresa de e-mail valida in campul: ',
            minlength: ' trebuie sa fie mai mare de '
        }
        ...
        formElements.each(function(){
            ...
            if(minLength){
                if( value.length < parseInt(minLength) ){
                    this.focus();
                    formok = false;
                    errors.push(nameUC + errorMessages.minlength + minLength + ' caractere');
                    return false;
                }
            }
        });
